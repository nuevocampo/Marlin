...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_ACTIVE 140 // (0-255) Active speed, used when any motor is enabled
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 10*60, 150 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0       // Unit: mm compression per 1mm/s extruder speed
                                // K=0 off by default for M2G, set with M900 per filament type
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       955        // (mA) RMS current. Multiply by 1.414 for peak current.
